 ...
 */
@Api(value = "/ib/queryCapital", version = { "1.6.0" }, osType = { OsType.ANDROID,OsType.IOS })
public class IbQueryCapital extends AbstractApi<IbResponse, IbRequest>
{
	...
	public IbResponse execute(IbRequest request)
	{
		...
		try
		{
			...
			{
				if (request.getOsType().equalsIgnoreCase(OsType.IOS)) {
					System.out.println("IOS版本");
					// 获取美国时间
