 ...
 */
@Api(value = "/ib/queryCapital", version = { "1.6.2" }, osType = { OsType.IOS, OsType.ANDROID })
  ...
  public IbResponse execute(IbRequest request)
  {
    ...
    try
    {
      ...
      else
      {
        ...
        response.setUsaTime(sdf2.format(calendar2.getTime()) + " 16:00 EDT");
        // 判断时间是否开盘
        ...
        String tradeTime = "10:30-17:00";
        SimpleDateFormat sdf3 = new SimpleDateFormat("yyyy/MM/dd HH:mm");
        Calendar calendar3 = Calendar.getInstance();
        sdf3.setTimeZone(TimeZone.getTimeZone("America/New_York"));
        // 判断时间
        int mouth = calendar3.get(Calendar.MONTH);
        System.out.println(mouth + "月份啦啦啦啦");
        if (mouth > 3 && mouth < 10)
        {
          timeState = "EDT";
          tradeTime = "9:30-16:00";
        }
        ...
        response.setLstStockInfo(lstStockInfo);
        // 查询是否持仓，返回持仓数量，默认0
        int position = 0;
