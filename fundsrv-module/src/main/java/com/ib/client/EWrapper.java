...
public interface EWrapper extends AnyWrapper
{
	...
	void positionEnd(String account);
	...
	List<PositionsInfo> getPositions(String account);
	
	List<BrokerOrder> getExecutionOrder(String account);

	List<MarketData> getMarketValue(String account);

	String getCashBalance(String account);

	HmStockInfo getMktData(int tickerId, String symbol);
