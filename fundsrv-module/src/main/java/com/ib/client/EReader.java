...
public class EReader extends Thread {
    ...
    public void run() {
        try {
        	...
        	// System.out.println(isInterrupted() + "----" + readInt());
            while( !isInterrupted() && processMsg(readInt()));
            // System.out.println("EReader is run");
        }
        catch ( Exception ex ) {
        	System.out.println("出错了呀--------");
        	ex.printStackTrace();
	...
	protected boolean processMsg(int msgId) throws IOException{
        ...
        case TICK_PRICE: {
            ...
            if( version >= 2) {
                ...
                if (sizeTickType != -1) {
                	System.out.println("tickSize2222:" + tickerId + "====" + sizeTickType + "====" + size);
        ...
        case TICK_SIZE: {
            ...
            int tickType = readInt();
            int size = readInt();
            System.out.println("tickSize:" + tickerId + "...." + tickerId + "...." + tickType + "...." + size);
            ...
            case POSITION:{
            	...
            	System.out.println(account + "接收持仓记录" + contract.m_symbol + "数量" + pos);
            ...
            case POSITION_END:{
                int version = readInt();
                System.out.println("POSITION_END" + version);
//                String account = "";
//                try {
//                	String account22 = readStr();
//                	String account33 = readStr();
//                	String account44 = readStr();
//                	String account55 = readStr();
//                	String account66 = readStr();
//                	String account77 = readStr();                    
//                	if (2 == version) {
//                        account = account77;
...
//                    System.out.println(readStr());
//                    System.out.println("account1111=" + readStr());
//                    System.out.println(readStr());
//                    String account = readStr();
//                    System.out.println("account=" + account);
...
//				}
            ...
            case ACCT_VALUE: {
               ...
               // System.out.println("接收账户信息===" + key + "==" + val + ",cur==" + cur + ",account==" + accountName);
            ...
            case OPEN_ORDER: {
                ...
                // System.out.println("账户名--" + order.m_account);
                if(version >= 3) {
            ...
            case EXECUTION_DATA: {
            	// System.out.println("EXECUTION_DATA===");
                int version = readInt();
            ...
            case HISTORICAL_DATA: {
            	System.out.println("HISTORICAL_DATAooooooooooooooooo");
              int version = readInt();
              int reqId = readInt();
        	  String startDateStr;
        	  String endDateStr;
            ...
            case OPEN_ORDER_END: {
            	System.out.println("===========OPEN_ORDER_END");
                /*int version =*/ readInt();
            ...
            case EXECUTION_DATA_END: {
            	System.out.println("交易记录更新rrrrr");
                /*int version =*/ readInt();
                int reqId = readInt();
            ...
            default: {
            	System.out.println("报错2222222222222");
