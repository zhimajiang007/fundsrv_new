...
public class ApiController implements EWrapper {
	...
	public ApiController( IConnectionHandler handler, ILogger inLogger, ILogger outLogger) throws SocketException {
	...
	public void connect( String host, int port, int clientId) throws SocketException {

		clientId = InitContants.TWS_CLIENTID;
	...
	@Override public void positionEnd(String account) {
		for (IPositionHandler handler : m_positionHandlers) {
			handler.positionEnd();
		}
		recEOM();
